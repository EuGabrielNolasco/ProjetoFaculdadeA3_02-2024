<!-- resources/views/menus/departamentos/edit.blade.php -->
<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-2xl text-gray-800 leading-tight">
                {{ __('Editando Departamento') }}
            </h2>
                ...
                <form action="{{ route('departamentos.update', $departamentos->id) }}" method="POST">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name', $departamentos->name) }}"
                                class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-colors duration-200" required>
                        </div>

                        <!-- Responsabilidade -->
                        <div class="space-y-2">
                            <label for="description" class="block text-sm font-medium text-gray-700">Responsabilidade</label>
                            <input type="text" id="description" name="description" value="{{ old('description', $departamentos->description) }}"
