            ...
            <div class="p-6 sm:p-8">
                <form action="{{ route('turnos.update', $turnos->id) }}" method="POST">
                    ...
                    <div class="space-y-6">
                        ...
                        <!-- Hora Entrada -->
                        <div class="space-y-2">
                            <label for="start_time" class="block text-sm font-medium text-gray-700">Hora Entrada</label>
                        ...
                        <!-- Hora Saída -->
                        <div class="space-y-2">
                            <label for="end_time" class="block text-sm font-medium text-gray-700">Hora Saída</label>
